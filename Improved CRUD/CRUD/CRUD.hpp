...
class CRUD : Menu {
    ...
    private:
        ...
        void searchMhsFaculProdi(bool isProdi, string& data){
            ifstream file("./DB/db-mhs.txt");
            string line;
            int isExist = 0, nomorMhs = 1;
            bool pengaman = false;
            while (getline(file, line)) {
                stringstream ss(line);
                ...
                if(isProdi){
                    if(prodi == data){
                        ...
                        cout << "     ";
                        cout << setw(3) << left << nomorMhs;
                        cout << setw(30) << left << nama;
                        cout << setw(15) << left << nim;
                        cout << setw(25) << left << prodi;
                        cout << setw(17) << left << fakultas << endl;
                        nomorMhs++;
                        this->SetConsoleColor(WHITE, BLACK);    
                    }
...
// =================== Menambahkan Data Mahasiswa =================== //
        void addDataMhs(){
            ...
            // Pengondisian jika data akan diinputkan ke db
                ...
                ofstream file("./DB/db-mhs.txt", ios::app);
                file << data << endl;
                file.close();
        ...
        void deleteDataMhs(){
            ...
            if(deleteNum <= repeat - 1){
                ...
                if(confirm == 'y' || confirm == 'Y'){
                    ...
                    // Menulis ke database
                    ofstream file("./DB/db-mhs.txt", ios::trunc);
                    int nomorMhs = 1;
                    string data;
            ...
            if(updateNum <= repeat - 1){
                ...
                if(confirm == 'y' || confirm == 'Y'){
                    ...
                    // Pengondisian jika data akan diinputkan ke db
                        ...
                        ofstream file("./DB/db-mhs.txt", ios::out);
                        string data = "";
        ...
        void searchDataMhs(){
            ...
            if(this->isDBKosong()){
                ...
                if(userChoice == 1){
                    ...
                    getline(cin, nama);
                    this->hiasan(90);
                    bst.showSearchByNama(nama);
                } else if(userChoice == 3){
                    string prodi;
                    this->hiasan(90);
                    cout << "Pencarian Berdasarkan Prodi" << endl;
                    this->hiasan(90);
                    cout << "Masukkan Prodi : ";
                    cin.ignore();
                    getline(cin, prodi);
                    this->hiasan(90);
                    this->searchMhsFaculProdi(true, prodi);
                }else if(userChoice == 4){
                    string fakultas;
                    this->hiasan(90);
                    cout << "Pencarian Berdasarkan Fakultas" << endl;
                    this->hiasan(90);
                    cout << "Masukkan Fakultas : ";
                    cin.ignore();
                    getline(cin, fakultas);
                    this->hiasan(90);
                    this->searchMhsFaculProdi(false, fakultas);
                } else {
                    this->SetConsoleColor(RED, BLACK);
...
// =================== Kunjungi Fakultas =================== //
        void visitFaculty(){
            system(CLEAR_CONSOLE);
            cout << "PILIH SUB MENU" << endl;
            this->hiasan(90);
            cout << "1. Tampilkan Jarak Semua Fakultas" << endl;
            cout << "2. Tampilkan Hubungan Jarak Antar Fakultas" << endl;
            cout << "3. Mencari Jarak Fakultas Terdekat" << endl;
